 ...
 *
 * The report endpoints are Sanctum-protected, so the file has to travel
 * through axios (bearer header attached) rather than a plain `<a href>` — this
 * turns the resulting blob back into a save dialog.
 *
