...
const commonActivity = [
  ...
  {
    timestamp: 'Jan 9, 11:05 AM',
    action: 'document.upload',
    details: 'upload passport scan to file #3081',
  },
...
export const mockUsers: User[] = [
  {
    ...
    faculties: [],
    status: 'Active',
    lastLogin: 'Jan 19, 2026',
    createdAt: 'Dec 1, 2025',
    permissions: archivistPermissions,
  ...
  },
  {
    ...
    role: 'Faculty staff',
    faculties: ['IT', 'Business'],
    status: 'Active',
    lastLogin: 'Jan 17, 2026',
